...
inline auto make_function(primitive_tag returnTypeTag, Vec<primitive_tag> paramTypeTags, Vec<primitive_tag> paramWithDefault = {}) -> FunctionType
{
...
{
    REQUIRE(make_function(primitive_tag::I32, {primitive_tag::I32}).repr() == "fun (i32) -> i32");
    REQUIRE(make_function(primitive_tag::I32, {}, {primitive_tag::I32}).repr() == "fun (i32 = default) -> i32");
    REQUIRE(make_function(primitive_tag::UNIT, {primitive_tag::I32}).repr() == "fun (i32) -> unit");
    REQUIRE(make_function(primitive_tag::I32, {primitive_tag::I32, primitive_tag::I32}).repr() == "fun (i32, i32) -> i32");
    REQUIRE(make_function(primitive_tag::UNIT, {primitive_tag::I32, primitive_tag::I32}).repr() == "fun (i32, i32) -> unit");
    REQUIRE(make_function(primitive_tag::UNIT, {primitive_tag::I32}, {primitive_tag::I32}).repr() == "fun (i32, i32 = default) -> unit");
    REQUIRE(make_function(primitive_tag::UNIT, {}, {primitive_tag::I32, primitive_tag::I32}).repr() == "fun (i32 = default, i32 = default) -> unit");
}

TEST_CASE("test FunctionType#match", "[TypeCheck][Function][Covariance]")
{
    // fun (i32, i32) -> i32
    auto basic_function = make_function(primitive_tag::I32, {primitive_tag::I32, primitive_tag::I32});
    // self-reflexivity
    REQUIRE(basic_function.match(basic_function));

    // wider return type fun (i32, i32) -> i64
    auto wider_return_type = make_function(primitive_tag::I64, {primitive_tag::I32, primitive_tag::I32});
    ...
    auto narrower_return_type = make_function(primitive_tag::I16, {primitive_tag::I32, primitive_tag::I32});
    ...
    auto same_signature_with_extra_default_params =
        make_function(primitive_tag::I32, {primitive_tag::I32, primitive_tag::I32}, {primitive_tag::I32});
    ...
    auto narrower_params =
        make_function(primitive_tag::I32, {primitive_tag::I16, primitive_tag::I16});
    ...
    // fun (i64, i64) -> i32;
    auto wider_params =
        make_function(primitive_tag::I32, {primitive_tag::I64, primitive_tag::I64});
