...
| 5 | Source modules, imports, exports, prelude | `08`, `13`, `18`, `56`, `59` | Transitive `import` loading (`import name;` / selective list), `export` parsing, merged multi-module compilation with deterministic cycle/missing-module diagnostics (`example/vnext/modules/`); name-privacy enforcement, module interfaces/artifacts, and the stdlib prelude remain. | R3/R6/R7 |
