...
| Arrays and indexing | `06`, `18`, `24`, `56`, `58`, `59` | Dynamic/fixed canonical types, nested literals, reads, mutable index places, checked bounds, and value spreads splicing range/slice elements into array literals (`[...(1..5)]`, `[0, ...xs, 9]`, `example/std_string.ng`) are supported | Affine move/clone policy and descriptor-directed storage remain. |
