...
| Arithmetic, comparison, prefix, logical, bitwise | `03`, `10`, `58` | Supported across the fixed-width integer tower (`i8`–`i64`, `u8`–`u64`) with contextual literal typing and per-width range checks | Runtime per-width overflow checks, literal suffixes, and float compatibility remain. |
