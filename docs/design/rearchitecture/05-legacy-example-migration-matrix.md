...
| 10 | Variadic type/value packs, ranges/slices, folds | `49`, `54`, `57`, `58`, `59` | Heterogeneous variadic type packs (`T...` parameters/returns, tuple-literal spreads, per-instance tuple lowering) are supported (`example/vnext/variadic_packs.ng`); call-site spreads, array spreads/folds, ranges/slices, and `sizeof_pack`/`tuple_element` remain. | R4–R7 |
