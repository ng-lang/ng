...
| R3 | CompilationSession and module graph | In progress — vNext module name-resolution seed; transitive `import` loading with merged compilation units, `export` parsing, and deterministic cycle/missing-module diagnostics | R1 | Session-scoped resolver/artifact cache |
