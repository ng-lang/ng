...
| R9 | Native ABI, C FFI, opaque types, and bindgen | In progress — `native fun` runtime intrinsics with a session-owned registry, `print`/`assert` builtins, and vNext stdlib io/string natives | R4, R6, R7 | Declared ABI descriptors and safe C boundary |
