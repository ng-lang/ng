...
namespace NG::library::imgui
{
    ...
    static Map<Str, NGInvocable> handlers{
        {"init", [](const NGSelf &self, const NGCtx &context, const NGInvCtx &invCtx)
         {
             // Setup SDL
             ...
             window = SDL_CreateWindow("Dear ImGui NG Binding + SDL3 backend Example", (int)(1280 * main_scale), (int)(720 * main_scale), window_flags);
             if (window == nullptr)
             {
        ...
        {"eventLoop", [](const NGSelf &self, const NGCtx &context, const NGInvCtx &invCtx)
         {
        ...
        {"checkMinimized", [](const NGSelf &self, const NGCtx &context, const NGInvCtx &invCtx)
         {
        ...
        {"NewFrame", [](const NGSelf &self, const NGCtx &context, const NGInvCtx &invCtx)
         {
        ...
        {"End", [](const NGSelf &self, const NGCtx &context, const NGInvCtx &invCtx)
         {
             ImGui::End();
         }},
        ...
        {"Render", [](const NGSelf &self, const NGCtx &context, const NGInvCtx &invCtx)
         {
             ImGui::Render();
        ...
        {"cleanup", [](const NGSelf &self, const NGCtx &context, const NGInvCtx &invCtx)
         {
             // Cleanup
